...
from services import LLMService, StockAnalysisService, FormattingService, QueryService
...
def create_app(config_object=None):
    ...
    stock_bp = init_stock_routes(stock_service, query_service, formatting_service)
